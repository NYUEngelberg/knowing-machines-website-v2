          ...
          <div className={"pb-10 md:p-10 relative"}>
            ...
            <div className="flex flex-col gap-6 sm:m-0 mx-8 ">
              ...
              <iframe
                ...
                scrolling="no"
                seamless
                src="https://player.simplecast.com/da7d84a6-ef94-44cb-a700-5b88f0786904?dark=false"
              ></iframe>
              <iframe
                className="border-black border-[1px]"
                height="200px"
              ...
              <iframe
                ...
                scrolling="no"
                seamless
                src="https://player.simplecast.com/25b16540-21f7-4c8e-a06c-b559da433c25?dark=false"
              ></iframe>
              <iframe
                className="border-black border-[1px]"
                height="200px"
                ...
                scrolling="no"
                seamless
                src="https://player.simplecast.com/f6d59707-1663-48e1-a185-452e0d4c5f97?dark=false"
              ></iframe>
              <iframe
                className="border-black border-[1px]"
                height="200px"
                ...
                scrolling="no"
                seamless
                src="https://player.simplecast.com/bd2b0ede-6126-40e9-bc08-81f2913e74d3?dark=false"
              ></iframe>
